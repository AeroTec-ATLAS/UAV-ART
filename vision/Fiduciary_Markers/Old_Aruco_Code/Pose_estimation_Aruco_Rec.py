...
#MATRIX ARTHUR
#camera_matrix = np.array([[952.43177038,   0.,         549.30264452],
# [  0.,         970.45074836, 383.53723324],
# [  0.,           0.,           1.        ]] )
...
aruco_dict = aruco.getPredefinedDictionary(aruco.DICT_ARUCO_ORIGINAL) #Libraries used: aruco.DICT_ARUCO_ORIGINAL aruco.DICT_4X4_50
...
if data:
    ...
    plt.show()
    if Save:
        np.savetxt('test7.txt', data, fmt='%f')
