...
main_path = os.getcwd() + "/"
camera_matrix_original = np.loadtxt(main_path+'Camera_Matrix_iPhone.txt', delimiter =',')
camera_matrix = np.loadtxt(main_path+'Camera_Matrix_iPhone.txt', delimiter =',')
camera_distortion = np.loadtxt(main_path+'Camera_Distortion_iPhone.txt', delimiter =',')
...
img_markers = []
name = "/Images/New_Images/"  #PUT NAME OF IMAGE HERE
...
#img = img_markers[0]
cap = cv.VideoCapture(main_path + "/Images/New_Images/C_fast_short.MOV")
suc, img = cap.read()
scale_percent = 150
