...
%   - This function is only to be replaced with a state estimator if the
%   dynamics of the sensors are to be included in the simulation (check
%   chapter VII and VIII of the book).
%
% Outputs are:
