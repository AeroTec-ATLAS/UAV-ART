...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ESCInfoItem>)))
  ...
  "968983ff768dda90f04c5aa11caf6e74")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ESCInfoItem)))
  "Returns md5sum for a message object of type 'ESCInfoItem"
  "968983ff768dda90f04c5aa11caf6e74")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ESCInfoItem>)))
  ...
  (cl:format cl:nil "# ESCInfoItem.msg~%#~%#~%# See mavlink message documentation here:~%# https://mavlink.io/en/messages/common.html#ESC_INFO~%~%std_msgs/Header header~%~%uint16 failure_flags~%uint32 error_count~%int32 temperature~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ESCInfoItem)))
  "Returns full string definition for message of type 'ESCInfoItem"
  (cl:format cl:nil "# ESCInfoItem.msg~%#~%#~%# See mavlink message documentation here:~%# https://mavlink.io/en/messages/common.html#ESC_INFO~%~%std_msgs/Header header~%~%uint16 failure_flags~%uint32 error_count~%int32 temperature~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
