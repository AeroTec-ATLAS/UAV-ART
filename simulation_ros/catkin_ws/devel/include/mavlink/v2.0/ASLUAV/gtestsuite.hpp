...
TEST(ASLUAV, SENSOR_AIRFLOW_ANGLES)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ASLUAV::msg::SENSOR_AIRFLOW_ANGLES packet_in{};
    packet_in.timestamp = 93372036854775807ULL;
    packet_in.angleofattack = 73.0;
    packet_in.angleofattack_valid = 53;
    packet_in.sideslip = 101.0;
    packet_in.sideslip_valid = 120;

    mavlink::ASLUAV::msg::SENSOR_AIRFLOW_ANGLES packet1{};
    mavlink::ASLUAV::msg::SENSOR_AIRFLOW_ANGLES packet2{};
    ...
    EXPECT_EQ(packet1.timestamp, packet2.timestamp);
    EXPECT_EQ(packet1.angleofattack, packet2.angleofattack);
    EXPECT_EQ(packet1.angleofattack_valid, packet2.angleofattack_valid);
    EXPECT_EQ(packet1.sideslip, packet2.sideslip);
    EXPECT_EQ(packet1.sideslip_valid, packet2.sideslip_valid);
}

#ifdef TEST_INTEROP
TEST(ASLUAV_interop, SENSOR_AIRFLOW_ANGLES)
{
    mavlink_message_t msg;
    ...
    mavlink_sensor_airflow_angles_t packet_c {
    ...
    mavlink_msg_sensor_airflow_angles_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.timestamp, packet2.timestamp);
    EXPECT_EQ(packet_in.angleofattack, packet2.angleofattack);
    EXPECT_EQ(packet_in.angleofattack_valid, packet2.angleofattack_valid);
    EXPECT_EQ(packet_in.sideslip, packet2.sideslip);
    EXPECT_EQ(packet_in.sideslip_valid, packet2.sideslip_valid);
