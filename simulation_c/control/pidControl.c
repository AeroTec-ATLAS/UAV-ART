...
void initialization(pidControl* pc, double kp, double ki, double kd, double Ts, 
					double sigma, double low_limit, double high_limit){
...
double update(pidControl* pc, double prev_u, double y_ref, double y, bool reset_flag){
	...
	//PID control
	u = prev_u + pc->kp * error + pc->ki * pc->integrator + pc->kd * error_dot;
...
double update_with_rate(pidControl* pc,  double y_ref, double y, double ydot, bool reset_flag){
