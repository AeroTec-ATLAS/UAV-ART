function [T_phi_delta_a,T_p_delta_a,T_chi_phi,T_theta_delta_e, T_theta_dot_delta_e,T_h_theta,T_h_Va,T_Va_delta_t,T_Va_theta,T_Va,T_v_delta_r,G]...
    ...
    G.a_V1 = P.rho*G.Va_trim*P.S_wing*(P.C_D_0 + P.C_D_alpha*alpha_trim + ...
                    P.C_D_delta_e*delta_e_trim)/P.mass + P.rho*P.S_prop*P.C_prop*G.Va_trim/P.mass;
